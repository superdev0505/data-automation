...
{
  // echo $row['exports']; echo ";"; // hkg
  $_SERVER['DB']->bind($stm_history,Array(intval($_SESSION['uid']),substr($row['datum'],0,10),$row['turnarounds'],$row['exports'],$row['extra_exports'],$row['padd_demand'],
...
{
  $_SERVER['DB']->bind($stm_forecast,Array(intval($_SESSION['uid']),substr($row['datum'],0,10),$row['turnarounds'],$row['yield'],$row['imports'],$row['exports'],
